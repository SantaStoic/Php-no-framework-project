        ...
        <div class="mx-auto container">
          <form id="edit-form" method="POST" action="edit_product.php" >
            ...
            <?php foreach($products as $product){ ?>
              ...
              <label>Title</label>
              <input type="text" class="form-control" value="<?php echo $product['product_name']; ?>" id="product-name" name="title" placeholder="Title" required />
            </div>
            <div class="form-group mt-2">
            ...
            <div class="form-group mt-2">
              <label>Price</label>
              <input type="text" class="form-control" value="<?php echo $product['product_price']; ?>" id="product-price" name="price" placeholder="Price" required/>
            </div>
            <div class="form-group mt-2">
