    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-sh2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-sh2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-sh2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-sh2.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Shoes</h6>
          <h3 class="py-4">Men's sneaker with Interlocking G</h3>
          ...
          <span
            >Inspired by retro basketball shoes from the '70s, these sneakers
            are defined by the Interlocking G logo. Crafted by supple leather,
            this design features a perforated leather insert.</span
          >
          <div class="pt-3">
            <ul>
              <li>Black leather</li>
              <li>Men's</li>
              <li>Perforated leather insert</li>
              <li>Leather lining</li>
              <li>Rubber sole</li>
              <li>Additional pair of laces included</li>
              <li>Interlocking G details</li>
