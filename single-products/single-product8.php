    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-sh3.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-sh3.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-sh3.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-sh3.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Shoes</h6>
          <h3 class="py-4">Nike Field General</h3>
          ...
          <span
            >The Field General returns from its gritty American football roots
            to shake up the sneaker scene. It pairs heritage colours with a
            nubby Waffle sole—creating that vintage grid iron look.</span
          >
          <div class="pt-3">
            <ul>
              <li>Leather Swoosh logo</li>
              <li>Padded collar</li>
              <li>Foam midsole</li>
              <li>Rubber outsole</li>
              <li>Rubber sole</li>
              <li>Colour Shown: Pro Green/Gum Medium Brown/Pro Gold</li>
              <li>Style: HF3165-300</li>
