    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-sh1.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-sh1.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-sh1.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-sh1.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Shoes</h6>
          <h3 class="py-4">Men's Gucci Re-Web sneaker</h3>
          ...
          <span
            >The Re-Web sees Gucci’s heritage stripes as a bold statement detail
            on a contemporary silhouette. This pair is crafted from silver
            metallic leather and presents a metallic GG leather insert. Defined
            by multiple signature details, this new sneaker takes center stage
            with the bold green and red Web tongue.</span
          >
          <div class="pt-3">
            <ul>
              <li>Silver metallic leather</li>
              <li>Men's</li>
              <li>Metallic GG leather insert</li>
              <li>Leather lining</li>
              <li>Gucci script and Interlocking G Web tag</li>
              <li>Rubber outsole with Interlocking G and Gucci script logo</li>
      ...
      <div class="container text-center mt-5 py-5">
        ...
        <div class="row mx-auto container-fluid">
          <div class="product text-center col-md-4 col-sm-12">
            ...
            <button class="buy-btn" href="#mainImg">Buy Now</button>
          </div>
