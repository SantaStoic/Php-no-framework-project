    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-pt2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-pt2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-pt2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-pt2.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Pants</h6>
          <h3 class="py-4">Compact cotton twill pants with Web</h3>
          <p style="font-size: 1.2rem">Men's Pants</p>
          <h2>$1350</h2>
          <input type="number" name="" value="1" />
          <button class="buy-btn">Add To Cart</button>
          <h4 class="mt-5 mb-5">Product details</h4>
          <span
            >Classics such as elegant shirts and tailored jackets throughout the
            Cruise 2025 collection stand out with subtle details that elevate
            everyday looks. These structured pants have been made from a compact
            cotton twill and enriched with a heat-taped Gucci Web detail on the
            reverse.</span
          >
          <div class="pt-3">
            <ul>
              <li>Beige compact cotton twill</li>
              <li>Heat-taped Gucci Web detail</li>
              <li>Belt loops</li>
              <li>Two side pockets</li>
              <li>Two back pockets</li>
              <li>Button and zip fly closure</li>
              <li>
                Length: 43.3"; Waist: 17.5"; Hips: 22.4"; Hem width: 9.6"; based
                on a size 48 IT
              </li>
              <li>Made in Italy</li>
    ...
    <section id="related-products" class="my-5 pb-5">
      <div class="container text-center mt-5 py-5">
        ...
        <div class="row mx-auto container-fluid">
          ...
          <div class="product text-center col-md-4 col-sm-12">
            <img class="img-fluid mb-3" src="../assets/imgs/ft5.png" alt="" />
            <div class="star">
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i>
          ...
          <div class="product text-center col-md-4 col-sm-12">
            <img class="img-fluid mb-3" src="../assets/imgs/pt3.png" alt="" />
            <div class="star">
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i>
