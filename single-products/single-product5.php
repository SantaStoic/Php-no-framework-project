    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-ct3.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-ct3.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-ct3.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-ct3.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Top</h6>
          <h3 class="py-4">Nike Therma</h3>
          <p style="font-size: 1.2rem">Men's Therma-FIT Full-Zip Fitness Top</p>
          <h2>$90</h2>
          <input type="number" name="" value="1" />
          <button class="buy-btn">Add To Cart</button>
          <h4 class="mt-5 mb-5">Product details</h4>
          <span
            >Bring the heat to your cold-weather workout with the Therma Top.
            Super-soft fleece keeps the comfort levels high while you take your
            exercise routine to the next level. A relaxed feel means you can
            stretch and bench without anything holding you back.</span
          >
          <div class="pt-3">
            <ul>
              <li>Standard fit for a relaxed, easy feel</li>
              <li>Full-length front zip</li>
              <li>Woven zip pulls</li>
              <li>Front pockets</li>
              <li>Printed back neck tape</li>
              <li>3-panel hood</li>
              <li>Tipped drawcord with metal grommets</li>
              <li>Embroidered Swoosh graphic</li>
              <li>100% polyester</li>
              <li>Machine wash</li>
              <li>Colour Shown: Black/Black/White</li>
              <li>Style: DQ4830-010</li>
              <li>Country/Region of Origin: China, Vietnam</li>
            </ul>
          </div>
        </div>
      </div>
