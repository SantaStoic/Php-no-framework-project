    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-ft4.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-ft4.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-ft4.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-ft4.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Shirt</h6>
          <h3 class="py-4">Cotton-silk GG faille shirt</h3>
          ...
          <span
            ...
            styles with a point collar and chest pocket drawing from a boxy
            design. This style appears in a black cotton-silk GG faille.</span
          >
          <div class="pt-3">
            <ul>
              <li>Black cotton-silk GG faille</li>
              <li>Short sleeves</li>
              <li>Chest pocket</li>
              <li>Back yoke</li>
              <li>Front button closure</li>
              <li>
                Length: 32.7"; Shoulder: 24.2"; Chest: 54.3"; Sleeves length:
                23";
              </li>
              <li>based on a size 48 IT</li>
              <li>Made in Italy</li>
              <li>The product shown in this image is a size 52 (IT)</li>
              <li>Fabric: 69% Cotton, 31% Silk.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container text-center mt-5 py-5">
        ...
        <div class="row mx-auto container-fluid">
          <div class="product text-center col-md-4 col-sm-12">
            ...
            <h5 class="p-name">Cotton-silk GG faille short shorts</h5>
            <h4 class="p-price">$1650</h4>
