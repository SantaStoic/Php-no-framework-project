    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-ft2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-ft2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-ft2.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-ft2.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Women/Shoes</h6>
          <h3 class="py-4">Nike Air Max Portal</h3>
          <p style="font-size: 1.2rem">Women's Shoes</p>
          <h2>$132.99</h2>
          <input type="number" name="" value="1" />
          <button class="buy-btn">Add To Cart</button>
          <h4 class="mt-5 mb-5">Product details</h4>
          <span
            >Transport your style with a new Air Max. The Portal is the perfect
            blend of chunky and sleek, combining the platform sole of 2000s with
            the minimalist upper of contemporary designs. We added an
            oval-shaped midsole with cloud-like cushioning for an elevated look
            you can wear every day. It's so comfortable it's out of this
            world.</span
          >
          <div class="pt-3">
            <ul>
              ...
              <li>Colour Shown: Black/Hot Punch/Sail/Volt</li>
              <li>Style: HF3053-006</li>
