    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-ct1.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-ct1.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-ct1.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-ct1.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Jacket</h6>
          <h3 class="py-4">Nike ACG 'Lunar Lake' PrimaLoft®</h3>
          ...
          <span
            >Fully equipped and built for cold-weather adventures, the 'Lunar
            Lake' ACG puffer offers PrimaLoft® Thermoplume insulation to help
            keep you warm. The neck zips up higher than the average jacket to
            cover part of your face and help you stay shielded from the cold.
            When the weather warms up, the jacket packs down into its own
            packable bag for easy transport.</span
          >
          <div class="pt-3">
            <ul>
              <li>A "Lunar Lake" woven patch label on the packable sack</li>
              <li>Embroidered ACG logo on the front of the chest</li>
              <li>Body: 100% nylon. Lining/Fill: 100% polyester.</li>
              <li>Imported</li>
              <li>
                Colour Shown: Light Orewood Brown/Light Orewood
                Brown/Anthracite/Summit White
              </li>
              <li>Style: HF0033-104</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <section id="related-products" class="my-5 pb-5">
      <div class="container text-center mt-5 py-5">
        ...
        <div class="row mx-auto container-fluid">
          ...
          <div class="product text-center col-md-4 col-sm-12">
            <img class="img-fluid mb-3" src="../assets/imgs/ct2.png" alt="" />
            <div class="star">
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i>
            ...
            <h5 class="p-name">Men's Dri-FIT UV Short-sleeve Versatile Top</h5>
            <h4 class="p-price">$55</h4>
            <button class="buy-btn">Buy Now</button>
          </div>
