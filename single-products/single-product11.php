    ...
    <section class="container single-product my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-6 col-sm-12">
          ...
          <div class="small-img-group">
            <div class="small-img-col">
              <img
                src="../assets/imgs/small1-ft6.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small2-ft6.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small3-ft6.png"
                width="100%"
                class="small-img"
                alt=""
              />
            ...
            <div class="small-img-col">
              <img
                src="../assets/imgs/small4-ft6.png"
                width="100%"
                class="small-img"
                alt=""
              />
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <h6>Men/Shirt</h6>
          <h3 class="py-4">Lasered denim shirt</h3>
          ...
          <span
            ...
            subtle details that elevate everyday looks. This shirt is stated in
            a washed certified cotton denim and enriched with a lasered Gucci
            Made in Italy Liftboy crest and Gucci selvedge detail.</span
          >
          <div class="pt-3">
            <ul>
              ...
              <li>Side splits with snap buttons</li>
              <li>Gucci selvedge detail</li>
              <li>Button closure</li>
              <li>
                Total length: 31.7"; Shoulder: 24.6"; Chest: 26.8"; Sleeves
                length: 11.2"; based on a size 48 IT
              </li>
              <li>Made in Italy</li>
